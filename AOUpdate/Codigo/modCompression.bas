...
Public Sub Descomprimir(Archivo As String, Size As Long)
Dim Data() As Byte
Dim RF As Integer
RF = FreeFile()
Open Archivo For Binary Access Read Lock Write As RF
    ReDim Data(LOF(RF) - 1)
    Get RF, , Data
Close RF
Call Decompress_Data(Data, Size)
RF = FreeFile()
Open Archivo & "des" For Binary Access Read Write As RF
    Put RF, , Data
Close RF
End Sub
Public Sub Comprimir(Archivo As String)
Dim Data() As Byte
Dim RF As Integer
RF = FreeFile()
Open Archivo For Binary Access Read Lock Write As RF
    ...
    Get RF, , Data
Close RF
Call Compress_Data(Data)
RF = FreeFile()
Open Archivo & "com" For Binary Access Read Write As RF
    Put RF, , Data
Close RF
End Sub
...
'On Local Error GoTo ErrHandler
    ...
    OutputFilePath = OutputPath & "Graphics2.PATCH" 'GRH_PATCH_FILE
...
'On Local Error GoTo ErrHandler
    ...
    ResourceFilePath = ResourcePath & GRH_RESOURCE_FILE
    PatchFilePath = PatchPath & "Graphics2.PATCH" 'GRH_PATCH_FILE
